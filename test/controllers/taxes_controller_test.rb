...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { Id_Impuesto: @tax.Id_Impuesto, NombreImpuesto: @tax.NombreImpuesto, PorcentajeImpuesto: @tax.PorcentajeImpuesto } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { Id_Impuesto: @tax.Id_Impuesto, NombreImpuesto: @tax.NombreImpuesto, PorcentajeImpuesto: @tax.PorcentajeImpuesto } }
