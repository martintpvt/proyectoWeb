...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { Cantidad: @detail.Cantidad, Descripcion: @detail.Descripcion, Id_Detalle: @detail.Id_Detalle, Id_Factura: @detail.Id_Factura, ValorUnitario: @detail.ValorUnitario } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { Cantidad: @detail.Cantidad, Descripcion: @detail.Descripcion, Id_Detalle: @detail.Id_Detalle, Id_Factura: @detail.Id_Factura, ValorUnitario: @detail.ValorUnitario } }
