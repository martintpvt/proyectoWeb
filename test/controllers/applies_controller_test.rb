...
class AppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post applies_url, params: { apply: { Id_Entidad: @apply.Id_Entidad, Id_Impuesto: @apply.Id_Impuesto } }
    end
  ...
  test "should update apply" do
    patch apply_url(@apply), params: { apply: { Id_Entidad: @apply.Id_Entidad, Id_Impuesto: @apply.Id_Impuesto } }
